...
def test_upload_asset_s3_unhandled_exception(
...
def test_upload_asset_s3_os_remove_error(
    apd_aws: PodcastDownloader, monkeypatch: pytest.MonkeyPatch, caplog: pytest.LogCaptureFixture
) -> None:
...
def test_check_path_exists_s3(apd_aws: PodcastDownloader, caplog: pytest.LogCaptureFixture) -> None:
...
def test_check_path_exists_s3_client_error(
    apd_aws: PodcastDownloader,
...
def test_check_path_exists_s3_unhandled_exception(
    apd_aws: PodcastDownloader, monkeypatch: pytest.MonkeyPatch, caplog: pytest.LogCaptureFixture
) -> None:
